...
class TestSplitNodes(unittest.TestCase):
    def test_split_nodes_link(self):
        ...
        self.assertEqual(
            new_nodes, expected_nodes, f"Expected {expected_nodes}, got {new_nodes}"
        )
    ...
    def test_split_nodes_image(self):
        ...
        node = TextNode(
            "Here is ![image1](https://example.com/img1.jpg) and ![image2](https://example.com/img2.jpg)",
            "text",
        )
        new_nodes = split_nodes_image([node])
        expected_nodes = [
...
"""
        expected_blocks = ["# Heading", "Paragraph"]
...
class TestBlockToBlockType(unittest.TestCase):
    ...
    def test_quote(self):
        ...
        self.assertEqual(
            block_to_block_type("> This is a multiline\n> quote block"), "quote"
        )
    ...
    def test_paragraph(self):
        self.assertEqual(
            block_to_block_type("This is just a regular paragraph of text."),
            "paragraph",
        )
        self.assertEqual(
            block_to_block_type("Another line of regular text."), "paragraph"
        )
    ...
    def test_mixed_content(self):
        ...
        self.assertEqual(
            block_to_block_type("1.This doesn't meet the ordered list format"),
            "paragraph",
        )
